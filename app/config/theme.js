...
import { capitalize,objects } from "utils";
...
const theme = {
  ...
  backgroundColors: objects.map((value, key) => ({
    [`backgroundColor${capitalize(key)}`]: {
      backgroundColor: value
    }
  }))(colors.primary),

  textColors: objects.map((value, key) => ({
    [`textColor${capitalize(key)}`]: {
      color: value
    }
  }))(colors.primary)
};
