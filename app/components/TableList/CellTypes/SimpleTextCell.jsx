...
class SimpleTextCell extends PureComponent {
  static propTypes = {
  ...
  render = () => {
    ...
    return (
      <TableListCellWrapper {...props}>
        <Typography className={classes.simpleText}>{text}</Typography>
      </TableListCellWrapper>
    );
  };
}

export default withStyles(styleSheet, { name: "SimpleTextCell" })(SimpleTextCell);
