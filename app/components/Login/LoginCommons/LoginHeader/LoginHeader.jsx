...
import { styleSheet } from "jss/Login/LoginCommons/LoginHeader";

export default withStyles(styleSheet, { name: "LoginHeader" })(props => {
  let headerIcon = null;
      ...
      <div className={props.classes.titleWrapper}>
        ...
        {props.subtitle && (
          <Typography
            type="subtitle"
            component="span"
            classes={{ root: props.classes.subtitle }}
          >
            {props.subtitle}
          </Typography>
        )}
